...
-- ============================================================
-- CORREÇÃO: get_financial_summary - pendingIncome/pendingExpense
-- Problema: busca no ledger mas pendentes NÃO têm ledger entries
-- Solução: buscar da tabela transactions (legado) onde status = 'PENDENTE'
-- ============================================================
...
BEGIN
  ...
  -- ============================================================
  -- CORREÇÃO CRÍTICA: RECEITA PENDENTE - da tabela transactions (legado)
  -- Transações pendentes NÃO têm ledger entries, então buscar direto
  -- ============================================================
  ...
  -- DESPESA PENDENTE - da tabela transactions (legado)
...
-- ============================================================
-- CORREÇÃO: get_total_pending_receivables
-- Buscar da tabela transactions (legado) onde status = 'PENDENTE'
-- ============================================================
...
-- ============================================================
-- CORREÇÃO: get_pending_this_month
-- Buscar da tabela transactions (legado) com vencimento este mês
-- ============================================================
