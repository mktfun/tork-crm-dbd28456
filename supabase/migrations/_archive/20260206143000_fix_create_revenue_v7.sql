-- =====================================================
-- FIX V7: Atualizar create_financial_movement com p_bank_account_id
-- =====================================================
-- 
-- Problema: Frontend envia p_bank_account_id mas a função não aceita.
-- Solução: Adicionar parâmetro e usar no INSERT.
--
-- Data: 2026-02-06
-- =====================================================
...
BEGIN
  ...
  -- Inserir transação com bank_account_id
  INSERT INTO financial_transactions (
    ...
    p_related_entity_id,
    p_bank_account_id, -- Valor inserido
    false
