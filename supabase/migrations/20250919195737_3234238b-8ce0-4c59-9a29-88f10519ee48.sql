-- Remove a view e função dependente usando CASCADE
DROP VIEW IF EXISTS public.clients_with_stats CASCADE;
...
-- Recria a função get_clients_with_stats que foi removida
