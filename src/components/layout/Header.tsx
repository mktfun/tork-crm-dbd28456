...
export function Header({ onSearchClick }: HeaderProps) {
  ...
  return (
    <header className="h-16 bg-background/95 backdrop-blur-lg border-b border-border">
      <div className="flex items-center justify-between h-full px-4 md:px-6">
        ...
        <div className="flex items-center gap-2 flex-1 justify-center md:justify-start">
          ...
          <Button
            ...
            className="text-muted-foreground hover:text-foreground hover:bg-muted gap-2 focus-visible:ring-0"
          >
        ...
        {/* Área direita - tema, notificações e perfil */}
