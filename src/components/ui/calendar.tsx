    ...
    <DayPicker
      ...
      classNames={{
        ...
        nav_button: cn(
          ...
          "h-7 w-7 p-0 text-muted-foreground hover:text-foreground hover:bg-accent/10 transition-colors"
        ),
        ...
        day_selected:
          "bg-primary text-primary-foreground hover:bg-primary/90 hover:text-primary-foreground focus:bg-primary focus:text-primary-foreground rounded-lg font-semibold shadow-[0_0_12px_hsl(var(--primary)/0.3)]",
        day_today: "text-primary font-bold relative after:absolute after:bottom-0.5 after:left-1/2 after:-translate-x-1/2 after:w-1 after:h-1 after:rounded-full after:bg-primary",
        day_outside:
