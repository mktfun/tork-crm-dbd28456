    ...
    <DayPicker
      ...
      classNames={{
        ...
        nav_button: cn(
          ...
          "h-7 w-7 bg-transparent p-0 opacity-70 hover:opacity-100 hover:bg-muted/50 border-border/50"
        ),
        ...
        day_today: "bg-muted text-foreground font-semibold relative after:absolute after:bottom-1 after:left-1/2 after:-translate-x-1/2 after:w-1 after:h-1 after:rounded-full after:bg-primary",
        day_outside:
