...
import { useWizardPersistence } from "@/modules/jjseguros/hooks/useWizardPersistence";
import { usePartialLead } from "@/modules/jjseguros/hooks/usePartialLead";
import { fetchCNPJData, formatCNPJ, isValidCNPJ } from "@/modules/jjseguros/utils/cnpjApi";
import { checkHealthQualification, type HealthQualificationConfig } from "@/modules/jjseguros/utils/qualification";
import { trackViewContent, trackLead, trackCompleteRegistration } from "@/modules/jjseguros/utils/metaPixel";
import { sendToRDStation, buildHealthPayload } from "@/modules/jjseguros/utils/dataProcessor";
